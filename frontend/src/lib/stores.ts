...
// For Dialogs
export const targetFolder = writable<Folder>()
export const creatingFolder = writable<boolean>(false);
export const renamingFolder = writable<boolean>(false);
export const deletingFolder = writable<boolean>(false);
export const uploadingFiles = writable<boolean>(false);
export const targetFile = writable<File>()
export const viewingFile = writable<boolean>(false);
export const deletingFile = writable<boolean>(false);
export const viewingUsage = writable<boolean>(false);
export const terminatingAccount = writable<boolean>(false);
